    ...
    <div className="mascot-container idle">
      <svg
        ...
        <g id="eon-owl">
          ...
          <path
            id="wing-left"
            d="M25 50 C 8 48, 5 65, 18 78 Q 28 70, 25 50 Z"
            fill="#8665A1"
          />
          {/* Cánh phải (dài ra - đối xứng) */}
          <path
            id="wing-right"
            d="M75 50 C 92 48, 95 65, 82 78 Q 72 70, 75 50 Z"
            fill="#8665A1"
          />
...
export default EonOwlSvgHandsUp;
